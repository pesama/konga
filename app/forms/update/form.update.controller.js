...
class FormUpdateController {
    constructor($scope, api, $routeParams, common, $rootScope, $filter, fieldMapper, scaffold, $timeout, permissionManager, util) {
...
FormUpdateController.$inject = ['$scope', 'api', '$routeParams', 'common', '$rootScope', '$filter', 'fieldMapper', 'scaffold', '$timeout', 'permissionManager', 'util'];
export default FormUpdateController;
