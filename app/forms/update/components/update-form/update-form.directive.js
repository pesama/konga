...
class UpdateFormComponent {
    constructor($routeParams, api, common, fieldMapper, $filter, util, mapper) {
        this.template = '<div ng-include="templateUrl"></div>';
        this.restrict = 'E';
        this.replace = true;
        this.scope = {
            entity: '=',
...
UpdateFormComponent.$inject = ['$routeParams', 'api', 'common', 'fieldMapper', '$filter', 'util', 'mapper'];
