...
class ResultTableComponent {
    constructor(util, mapper, $filter, $rootScope, permissionManager) {
        ...
        this.controller = function ($scope, $filter, $rootScope, permissionManager) {
            $scope.fields = [];
            $scope.categories = [];
            ...
            this.link = function postLink(scope, element, attrs) {
...
ResultTableComponent.$inject = ['util', 'mapper', '$filter', '$rootScope', 'permissionManager'];
