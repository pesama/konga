...
class FormSearchController {
    constructor($scope, api, $routeParams, common, $rootScope, $filter, scaffold, $timeout, permissionManager, util, configurationManager) {
...
FormSearchController.$inject = ['$scope', 'api', '$routeParams', 'common', '$rootScope', '$filter', 'scaffold', '$timeout', 'permissionManager', 'util', 'configurationManager'];
