 ...
 */
class KongaController {
	constructor($scope, $location, $filter, $rootScope, $timeout,common, scaffold, $translate, userData, $cookieStore, actionManager, $modal, permissionManager, kongaConfig, util, dialogs) {
...
KongaController.$inject = ['$scope', '$location', '$filter', '$rootScope', '$timeout','common', 'scaffold', '$translate', 'userData', '$cookieStore', 'actionManager', '$modal', 'permissionManager', 'kongaConfig', 'util', 'dialogs'];
export default KongaController;
