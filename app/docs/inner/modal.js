 ...
 * <pre>
{
  ...
  template: '/views/my-project-modal-tpl.html',
  parameters: {
 ...
 * You can inject `params` you will receive the {@link DataTypes.Modal.parameters `parameters`} configured when creating the modal
 * <pre>
