...
var customActions = {
    ...
    params: {
      'function': function(params) {
        ...
        if(settings && settings.autoCart) {
          ...
          // Verify if 0 stock
          if(!(params.item.stock > 0 || params.item.totalStock > 0)) {
            $rootScope.operations.addAlert(constants.ALERT_TYPE_ERROR, 'entity.catalog-product-details.cart.add.no-stock', {});
            return;
          }

          // Verify if not enough stock
          // if(!(params.item.totalStock > 0)) {
          //   $rootScope.operations.addAlert(constants.ALERT_TYPE_ERROR, 'entity.catalog-product-details.cart.add.no-stock', {});
          //   return;
          // }
  ...
  'add-tailoring-type-tailoring-type-field': {
    type: constants.ACTION_TYPE_MODAL,
    params: {
      template: '/views/custom/tailoring-add-tailoring-type-tailoring-type-field.html',
      controller: 'TailoringAddTailoringTypeTailoringTypeFieldCtrl',
      parameters: {
  ...
  'add-tailoring-type-tailoring-type-step': {
    type: constants.ACTION_TYPE_MODAL,
    params: {
      template: '/views/custom/tailoring-add-tailoring-type-tailoring-type-step.html',
      controller: 'TailoringAddTailoringTypeTailoringTypeStepCtrl',
      parameters: {
  ...
  'tailoring-type-custom-save': {
    type: constants.ACTION_TYPE_FUNCTION,
    params: {
      'function': function(params) {
        var scope = params.self;

        scope.operations.saveEntity(function(entity) {
          scope.entity = entity;
  ...
  'tailoring-type-tailoring-type-step-manage-options': {
    type: constants.ACTION_TYPE_MODAL,
    params: {
      template: '/views/custom/tailoring-type-tailoring-type-step-manage-options.html',
      controller: 'TailoringTypeTailoringTypeStepManageOptionsCtrl',
      parameters: {
