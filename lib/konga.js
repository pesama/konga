 ...
 */
angular.module('konga')
	.controller('KongaCtrl', ['$scope', '$location', '$filter', '$rootScope', '$timeout','common', 'scaffold', '$translate', 'userData', 'auth', 'User', '$cookieStore', 'actionManager', '$modal', 'permissionManager', 'kongaConfig', 'util', 
		function($scope, $location, $filter, $rootScope, $timeout,common, scaffold, $translate, Session, auth, User, $cookieStore, actionManager, $modal, permissionManager, kongaConfig, util) {
...
/**
 * @ngdoc filter
 * @name Konga Reference.filter:formType
 * @function
 * @description
 * # formType
...
angular.module('konga').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('/konga/views/raw-password-input.html',
    "<input name=\"{{ property.name }}\"type=\"password\" class=\"form-control konga-form-search-input\" id=\"{{ fieldId }}\" placeholder=\"\" ng-model=\"value.text\" ng-disabled=\"disableField(mode, property)\" angular.module('konga') ng-required=\"validation.required()\" maxlength=\"{{ validation.maxlength() }}\" autocomplete=\"off\">"
  );
  ...
  $templateCache.put('/konga/views/raw-plain-input.html',
    "<input name=\"{{ property.name }}\" type=\"text\" class=\"form-control konga-form-search-input\" id=\"{{ fieldId }}\" placeholder=\"\" ng-model=\"value.text\" ng-disabled=\"disableField(mode, property)\" angular.module('konga') ng-required=\"validation.required()\" maxlength=\"{{ validation.maxlength() }}\" tabindex=\"{{ (index + 1) * 12 }}\">"
  );
